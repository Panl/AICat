...
//  AICat
//
//  Created by Lei Pan on 2023/7/7.
//
...
func highlightedCodeBlock(
    ...
    case "swift":
        ...
        formatted.addAttributes(
            [.font: UFont.monospacedSystemFont(ofSize: fontSize, weight: .regular)],
    ...
    default:
        ...
        func unhighlightedCode() -> NSAttributedString {
            return NSAttributedString(
                string: code,
                attributes: [
                    .foregroundColor: brightMode ? UColor.black : UColor.white,
                    .font: UFont.monospacedSystemFont(ofSize: fontSize, weight: .regular),
                ]
            )
        }
